Feature: Configuration overrides
  ...
  Scenario: Override service name
    ...
    * the trace payload field "resourceSpans.0.resource" string attribute "service.name" equals "com.bugsnag.ServiceNameScenario"
