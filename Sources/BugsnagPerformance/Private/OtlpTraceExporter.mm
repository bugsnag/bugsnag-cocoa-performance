...
NSDictionary *
OtlpTraceExporter::encode(const Span &span) noexcept {
    return @{
...
NSDictionary *
OtlpTraceExporter::encode(const Span &span, NSDictionary *resourceAttributes) noexcept {
...
OtlpTraceExporter::encode(NSDictionary *attributes) noexcept {
